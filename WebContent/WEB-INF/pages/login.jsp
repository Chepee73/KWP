...
<!-- banner -->
	...
	<!-- navigation bar -->
		...
		<!-- //navigation bar -->
		<div class="w3agile_banner_info" style="position: center">
		<br>
		<br>
				<!-- formulario -->
					<div id="form-main">
						<div id="form-div-login">
						<h1 style="color:rgb(255,255,255); text-align:center" >Iniciar Sesión</h1>
						<br>
							<form class="form" id="form1" method="POST" action="http://127.0.0.1:8080">				  
							  <p class="username">
								<input name="name" type="text" class="validate[required,custom[onlyLetter],length[0,100]] feedback-input" placeholder="Username" id="username" />
							  ...
							  <p class="password">
								<input type="password" name="password" type="text" class="validate[required,custom[password]] feedback-input" placeholder="Password" id="password" />
								
							  </p>			  
				  
								<div class="login">
									<input type="submit" value="LOG IN" id="button-blue" onclick='alert(TextNameUser);'/>
										<div class="ease"></div>
								</div>
							</form>
						</div>
