...
<!-- portfolio -->
	<div class="portfolio">
		<div class="container">
			<h3 class="head head2" style="text-align:center">Curricula<span>Nuestro <i>programa</i> de educación.</span></h3>
                <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs" align="center">	
